    ...
    <div>
      ...
      <div className="relative">
        ...
        <div className="absolute right-3 top-1/2 -translate-y-1/2">
          {isChecking ? (
            <div className="w-5 h-5 border-2 border-text-muted border-t-accent rounded-full animate-spin" aria-hidden="true" />
          ) : isValid ? (
      ...
      <p id={helperId} className="text-text-muted text-xs mt-1">3-20 characters, letters and numbers only</p>
