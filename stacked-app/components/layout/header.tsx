...
export function Header() {
  ...
  return (
    <header className="grid grid-cols-3 md:flex md:justify-between items-center border-b border-border p-6 animate-fade-down">
      ...
      <Link
        href="/"
        className="hover:opacity-80 transition-opacity flex justify-center md:justify-start"
      >
        <Logo size="md" />
      </Link>
